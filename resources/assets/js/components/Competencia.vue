                        ...
                        <div class="modal-body">
                            <form id="modal-form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de la competencia">
        ...
        methods : {
            ...
            registrarCompetencia(){
                ...
                axios.post('/competencia/registrar',{
                    ...
                    toastr.success('Se ha registrado la competencia', 'Actualizado', {timeOut: 5000})
                }).catch(function (error) {
                    console.log(error);
            ...
            desactivarCompetencia(id){
               swal({
                title: 'Esta seguro de desactivar esta competencia?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put('/competencia/desactivar',{
                        ...
                        swal(
                        'Desactivado!',
                        'La competencia se ha desactivado con éxito.',
                        'success'
                        )
                    }).catch(function (error) {
                        console.log(error);
            ...
            activarCompetencia(id){
               swal({
                title: 'Esta seguro de activar esta competencia?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    axios.put('/competencia/activar',{
                        ...
                        swal(
                        'Activado!',
                        'La competencia se ha activado con éxito.',
                        'success'
                        )
                    }).catch(function (error) {
                        console.log(error);
            ...
            validarCompetencia(){
                ...
                if (!this.nombre) this.errorMostrarMsjCompetencia.push("Debe ingresar el nombre de la competencia");
